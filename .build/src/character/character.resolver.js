...
const character_inputs_1 = require("./character.inputs");
...
__decorate([
    graphql_1.Query(() => [character_model_1.Character]),
    __param(0, graphql_1.Args('filter', { nullable: true })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [character_inputs_1.ListCharacterInput]),
