...
const player_inputs_1 = require("./player.inputs");
...
__decorate([
    graphql_1.Query(() => [player_model_1.Player]),
    __param(0, graphql_1.Args('filter', { nullable: true })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [player_inputs_1.ListPlayerInput]),
    __metadata("design:returntype", Promise)
], PlayerResolver.prototype, "players", null);
